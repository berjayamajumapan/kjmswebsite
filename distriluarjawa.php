...
<frameset row=20%,*>
	<frameset cols=35%,*>
	<frame name=distributor src=distriluarjawa.php>
	</frameset>
</frameset>
...
<table width="99%" align="center">
	<tr>
		<td class="teksjudul" height="40">
			<font size="3"><img src="images/icon_siswa.gif" align="absmiddle" border="0">Alamat Agen dan Kantor Cabang Wilayah Jawa Tengah</font>
...
<table width="90%" align="center">
	<tr>
		...
		<br><font color="#0000FF" size="2"><blink>E-mail: dedipurwanto@gmail.com</blink></font></br>
							...
							<?php
							$result = mysql_query("select * from t_luarjawa ORDER by ID") or die(mysql_error());
							?>
