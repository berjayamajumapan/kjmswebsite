...
<frameset row=20%,*>
	<frameset cols=35%,*>
	<frame name=distributor src=distrijabar.php>
	</frameset>
</frameset>
...
<table width="99%" align="center">
	<tr>
		<td class="teksjudul" height="40">
			<font size="3"><img src="images/icon_siswa.gif" align="absmiddle" border="0">Perkebunan Yang Menjadi Customer Tetap Kami :</font>
...
--!>
							...
							<?php
							$result = mysql_query("select * from t_jabar ORDER by ID") or die(mysql_error());
							?>
