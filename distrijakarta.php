...
<frameset row=20%,*>
	<frameset cols=35%,*>
	<frame name=distributor src=distrijakarta.php>
	</frameset>
</frameset>
...
<table width="99%" align="center">
	<tr>
		<td class="teksjudul" height="40">
			<font size="3"><img src="images/icon_siswa.gif" align="absmiddle" border="0"> Project Pembangunan Yang Menjadi Customer Tetap Kami : </font>
...
--!>									<br><table width="90%" align="center">
							<?php
							$result = mysql_query("select * from t_jakarta ORDER by ID") or die(mysql_error());
							?>
