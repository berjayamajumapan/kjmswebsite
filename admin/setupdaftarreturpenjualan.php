...
if(isset($_GET['hapus'])){
	if($_GET['no']!=""){
		generate_query("delete","","tr_penjualan_retur","where NoPenjualan='".$_GET['no']."'","");
	}
	if(isset($_GET['no'])){
		$_GET['no']="";
	}
...
$result = mysql_query("select * from tr_penjualan 
					   inner join tr_penjualan_retur on tr_penjualan.NoPenjualan=tr_penjualan_retur.NoPenjualan 
					   order  by tr_penjualan.NoPenjualan") or die(mysql_error());
...
?>
                                ...
                                <tr>
                                        <td class="tekshitam">										
											...
											$result2 = mysql_query("select * from tr_penjualan_retur
										...
										<hr size="1">
                                                ...
                                                <table  bgcolor="#CC3300" cellspacing="1" border="0" width="95%" cellpadding="3" align="center">
                                                        ...
                                                        <tr bgcolor="#FDFDFD" class="tekshitamkecil" valign="top">
                                                                ...
                                                                <td>
                                                                        <a href="setupdaftarreturpenjualan.php?edit=1&no=<?php echo $row[0]?>" class="link">Lihat Detail Retur</a>
                                                                </td>
																<td>
																	<a href="setupdaftarreturpenjualan.php?hapus=1&no=<?php echo $row[0]?>" class="link">Delete</a>
																</td>
                                                        </tr>
                                                        <?php
                                                        }
