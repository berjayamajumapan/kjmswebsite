...
if(isset($_GET['edit'])){
        if($_GET['no']!=""){
                $result1= mysql_query("select * from tr_order where NoOrder='".$_GET['no']."'");
...
if(isset($_GET['hapus'])){
	if($_GET['no']!=""){
		generate_query("delete","","tr_order","where NoOrder='".$_GET['no']."'","");
		generate_query("delete","","tr_order_detail ","where NoOrder='".$_GET['no']."'","");
	}
	if(isset($_GET['no'])){
		$_GET['no']="";
	}
...
$result = mysql_query("select * from tr_order order  by NoOrder");
                                ...
                                <tr>
                                        <td class="tekshitam">										
											...
											<table width="95%" align="center">
												<tr>
													<td align="center"> 
													<form method="post" action="setuporder.php">
														<br>
									...
									<td>
                                                ...
                                                <table  bgcolor="#CC3300" cellspacing="1" border="0" width="95%" cellpadding="3" align="center">
                                                        ...
                                                        <tr bgcolor="#FDFDFD" class="tekshitamkecil" valign="top">
                                                                ...
                                                                <td>
                                                                        <a href="setuporder.php?edit=1&no=<?php echo $row[0]?>" class="link">Lihat Detail / Proses</a>
                                                                </td>
																<td>
																	<a href="setuporder.php?hapus=1&no=<?php echo $row[0]?>" class="link">Delete</a>
																</td>
                                                        </tr>
                                                        <?php
                                                        }
